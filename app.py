...
DATA_VERSION = "20260910_R6_LOCKED"
...
# 🎯 2026-09-09 盤後官方融資券 × 權證避險 × 主力分點最新校準資料庫 (Round 6 法定 12 檔)
DEFAULT_WATCHLIST = [
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 183.00, "昨日鎖碼量": 140400, "融資增減(張)": 7885, "券資比": 2.2, "權證認售(萬)": 0, "權證賣認購(萬)": -2261,
        "最高價": 190.50, "最低價": 180.50,
        "主力分點": [
            {"分點": "美商高盛", "買超": -16882, "均價": 184.43, "佔比": -12.02},
            {"分點": "台灣摩根士丹利", "買超": -12271, "均價": 184.16, "佔比": -8.74},
            {"分點": "摩根大通", "買超": -10599, "均價": 184.09, "佔比": -7.55},
            {"分點": "新加坡商瑞銀", "買超": -9011, "均價": 184.20, "佔比": -6.42},
            {"分點": "元大", "買超": -8131, "均價": 184.37, "佔比": -5.79},
            {"分點": "凱基-台北", "買超": -2136, "均價": 184.33, "佔比": -1.52},
            {"分點": "國泰-敦南", "買超": 2479, "均價": 184.67, "佔比": 1.77}
        ]
    },
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 99.50, "昨日鎖碼量": 56170, "融資增減(張)": -773, "券資比": 3.8, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 107.00, "最低價": 98.70,
        "主力分點": [
            {"分點": "美商高盛", "買超": 1277, "均價": 104.27, "佔比": 2.27},
            {"分點": "新加坡商瑞銀", "買超": 1154, "均價": 104.93, "佔比": 2.05},
            {"分點": "台灣摩根士丹利", "買超": 958, "均價": 103.82, "佔比": 1.71},
            {"分點": "康和", "買超": 923, "均價": 106.35, "佔比": 1.64},
            {"分點": "摩根大通", "買超": 853, "均價": 104.35, "佔比": 1.52},
            {"分點": "富邦", "買超": -1343, "均價": 105.09, "佔比": -2.39},
            {"分點": "美林", "買超": -557, "均價": 99.91, "佔比": -0.99}
        ]
    },
    {
        "代號": "2313", "名稱": "華通", "昨收": 228.00, "昨日鎖碼量": 20923, "融資增減(張)": 296, "券資比": 4.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 234.50, "最低價": 227.50,
        "主力分點": [
            {"分點": "大和國泰", "買超": -1970, "均價": 229.46, "佔比": -9.42},
            {"分點": "凱基-站前", "買超": -1679, "均價": 229.06, "佔比": -8.02},
            {"分點": "統一", "買超": -1341, "均價": 228.98, "佔比": -6.41},
            {"分點": "台灣摩根士丹利", "買超": -511, "均價": 229.98, "佔比": -2.44},
            {"分點": "凱基-台北", "買超": 576, "均價": 229.75, "佔比": 2.75}
        ]
    },
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 565.00, "昨日鎖碼量": 27670, "融資增減(張)": 426, "券資比": 3.7, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 585.00, "最低價": 563.00,
        "主力分點": [
            {"分點": "美林", "買超": -986, "均價": 570.97, "佔比": -3.49},
            {"分點": "美商高盛", "買超": -875, "均價": 570.28, "佔比": -3.10},
            {"分點": "摩根大通", "買超": -795, "均價": 569.71, "佔比": -2.81},
            {"分點": "新加坡商瑞銀", "買超": -517, "均價": 571.08, "佔比": -1.83},
            {"分點": "大和國泰", "買超": 562, "均價": 569.72, "佔比": 1.99}
        ]
    },
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 1110.00, "昨日鎖碼量": 5569, "融資增減(張)": 190, "券資比": 4.8, "權證認售(萬)": 61, "權證賣認購(萬)": 0,
        "最高價": 1110.00, "最低價": 980.00,
        "主力分點": [
            {"分點": "國票-敦北法人", "買超": 623, "均價": 1084.44, "佔比": 11.19},
            {"分點": "富邦", "買超": 375, "均價": 1101.49, "佔比": 6.73},
            {"分點": "凱基-城中", "買超": 186, "均價": 1110.00, "佔比": 3.34},
            {"分點": "凱基-信義", "買超": 138, "均價": 1070.65, "佔比": 2.48},
            {"分點": "花旗環球", "買超": -377, "均價": 1066.47, "佔比": -6.77}
        ]
    },
    {
        "代號": "2492", "名稱": "華新科", "昨收": 319.50, "昨日鎖碼量": 26073, "融資增減(張)": 467, "券資比": 3.0, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 323.00, "最低價": 312.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": -1440, "均價": 316.44, "佔比": -5.52},
            {"分點": "元大", "買超": 658, "均價": 318.19, "佔比": 2.52},
            {"分點": "康和", "買超": 623, "均價": 316.70, "佔比": 2.39},
            {"分點": "台灣摩根士丹利", "買超": -590, "均價": 316.03, "佔比": -2.26},
            {"分點": "新加坡商瑞銀", "買超": -586, "均價": 316.79, "佔比": -2.25}
        ]
    },
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 523.00, "昨日鎖碼量": 37518, "融資增減(張)": 257, "券資比": 2.8, "權證認售(萬)": 35, "權證賣認購(萬)": 0,
        "最高價": 535.00, "最低價": 521.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": -1810, "均價": 527.45, "佔比": -4.82},
            {"分點": "美商高盛", "買超": -1767, "均價": 526.88, "佔比": -4.71},
            {"分點": "元大", "買超": -1324, "均價": 526.85, "佔比": -3.53},
            {"分點": "富邦", "買超": -811, "均價": 528.24, "佔比": -2.16}
        ]
    },
    {
        "代號": "8039", "名稱": "台虹", "昨收": 289.50, "昨日鎖碼量": 33308, "融資增減(張)": -1400, "券資比": 6.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 299.00, "最低價": 282.00,
        "主力分點": [
            {"分點": "凱基-台北", "買超": 400, "均價": 289.62, "佔比": 1.20},
            {"分點": "統一", "買超": -411, "均價": 289.13, "佔比": -1.23},
            {"分點": "統一-仁愛", "買超": -300, "均價": 285.52, "佔比": -0.90},
            {"分點": "國票", "買超": 200, "均價": 288.36, "佔比": 0.60}
        ]
    },
    {
        "代號": "3260", "名稱": "威剛", "昨收": 414.50, "昨日鎖碼量": 7258, "融資增減(張)": 66, "券資比": 3.7, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 424.50, "最低價": 413.50,
        "主力分點": [
            {"分點": "合庫", "買超": 322, "均價": 418.60, "佔比": 4.44},
            {"分點": "美商高盛", "買超": -340, "均價": 416.90, "佔比": -4.68},
            {"分點": "元大", "買超": -243, "均價": 418.18, "佔比": -3.35}
        ]
    },
    {
        "代號": "3189", "名稱": "景碩", "昨收": 812.00, "昨日鎖碼量": 15225, "融資增減(張)": -164, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 835.00, "最低價": 805.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 1046, "均價": 820.43, "佔比": 6.87},
            {"分點": "凱基-台北", "買超": 396, "均價": 819.05, "佔比": 2.60},
            {"分點": "台灣摩根士丹利", "買超": 355, "均價": 821.88, "佔比": 2.33},
            {"分點": "摩根大通", "買超": 325, "均價": 816.23, "佔比": 2.13}
        ]
    },
    {
        "代號": "2455", "名稱": "全新", "昨收": 533.00, "昨日鎖碼量": 2499, "融資增減(張)": -256, "券資比": 5.4, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 552.00, "最低價": 523.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": 582, "均價": 539.99, "佔比": 23.29},
            {"分點": "美林", "買超": 300, "均價": 544.01, "佔比": 12.00},
            {"分點": "凱基-台北", "買超": 262, "均價": 538.88, "佔比": 10.48}
        ]
    },
    {
        "代號": "3037", "名稱": "欣興", "昨收": 993.00, "昨日鎖碼量": 21332, "融資增減(張)": -450, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 1005.00, "最低價": 980.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 1616, "均價": 994.51, "佔比": 7.58},
            {"分點": "花旗環球", "買超": 1307, "均價": 992.78, "佔比": 6.13},
            {"分點": "港商麥格理", "買超": 1035, "均價": 992.38, "佔比": 4.85}
        ]
    }
]
...
if st.session_state.get("APP_DATA_VERSION") != DATA_VERSION:
    ...
    st.session_state["selected_stock_code"] = "2344"

head_col1, head_col2 = st.columns([4, 1])
with head_col1:
    st.title("🎯 每日隔日沖主力短空雷達 (全自動AI智慧旗艦版)")
    st.caption("🔥 2026-09-09 盤後官方融資券 × 權證避險 × 分點資料庫完整封存！9/10 Round 6 決戰鎖定。")
with head_col2:
    st.write("")
    if st.button("🔄 強制重整 R6 盤後資料庫", use_container_width=True):
        st.session_state["custom_watchlist"] = DEFAULT_WATCHLIST
        st.session_state["selected_stock_code"] = "2344"
        st.cache_data.clear()
        st.rerun()
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        # 🎯 2026/09/09 盤後官方短空勝率演算法核心標定 (9/10 R6 實戰)
        if code == "2344": total_win_rate_score = 99     # 外資暴倒5.6萬張 + 融資暴增7,885張 + 認購大賣2,261萬 (多翻空踩踏)
        elif code == "2426": total_win_rate_score = 98   # 外資追高套牢5,100張 (均價104-106) + 盤中衝高跳水 + 融資退773
        elif code == "2313": total_win_rate_score = 97   # 凱基站前連2日大砍近8,800張 + 融資連3日逆勢大扛 + 測227.5頸線
        elif code == "2327": total_win_rate_score = 96   # 外資連2日大倒貨 (美林高盛小摩續砍) + 實體逼近563頸線
        elif code == "3406": total_win_rate_score = 91   # 國票敦北法人+雙凱基鎖漲停1110 + 外資全賣 + 認售避險 (隔日沖開高倒貨)
        elif code == "2492": total_win_rate_score = 82   # 高盛連2日大賣 + 大摩瑞銀同步調節 + 融資增467張
        elif code == "2408": total_win_rate_score = 75   # 大摩高盛反手出脫3,500張 + 融資增257張 (短線多頭衰竭)
        elif code == "8039": total_win_rate_score = 52   # 低檔震盪換手 (融資大退1400張，空方動能完成初步宣洩)
        elif code == "3260": total_win_rate_score = 45   # 量縮橫盤震盪，多空分點買賣均低於350張
        elif code == "3189": total_win_rate_score = 25   # 高盛大摩小摩集體回補逾2,000張，籌碼由空翻多
        elif code == "2455": total_win_rate_score = 15   # 大摩狂買582張 (佔比23.29%)，外資集團鎖碼，嚴禁摸頂
        elif code == "3037": total_win_rate_score = 10   # 高盛花旗麥格理合掃近4,000張攻千元，極高軋空禁碰
        else: total_win_rate_score = 50

        total_win_rate_score = max(min(total_win_rate_score, 99), 10)

        # 盤前信號定調
        if code in ["3037", "2455", "3189"]:
            short_alert_tag = "🛑 NO SHORT"
            full_alert_desc = f"🛑【極高軋空/籌碼回補】{name} 外資集中買超鎖碼或空單大回補，嚴禁做空"
            alert_color = "#FF0000"
            risk_level = "🔴 極高軋空 (嚴禁做空)"
            action_guide = "多頭主升或法人大舉回補，嚴禁逆勢摸頂。"
        elif total_win_rate_score >= 90:
            short_alert_tag = "⚡ 首選狙擊"
            full_alert_desc = f"⚡【核心空方破綻】主力重度出貨 / 融資套牢 / 隔日沖出脫，5分K實體跌破順勢開空"
            alert_color = "#00E5FF"
...
c2.metric("🎯 監控短空鎖碼標的", f"{len(df_display)} 檔 (R6 法定全數到位)")
...
with left_side:
    ...
    current_code = str(st.session_state.get("selected_stock_code", "2344"))
    current_idx = 0
