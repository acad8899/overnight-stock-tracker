...
STOCK_FUTURES_SET = {
    ...
    "2615", "8039", "5314", "2489", "3006", "2337", "8046", "2426", "2455"
}

# 內建常用台股代號與名稱對照字典
STOCK_NAME_DICT = {
    "2408": "南亞科", "3406": "玉晶光", "8039": "台虹", "2313": "華通", "2426": "鼎元",
    "3260": "威剛", "2615": "萬海", "2327": "國巨*", "2344": "華邦電", "2492": "華新科",
    "2455": "全新", "6933": "AMAX-KY", "2449": "京元電子", "3231": "緯創", "2489": "瑞軒",
    "6488": "環球晶", "2376": "技嘉", "2330": "台積電", "2317": "鴻海", "2454": "聯發科",
    "2382": "廣達", "2603": "長榮", "3037": "欣興", "2368": "金像電", "3017": "奇鋐",
    "2383": "台光電", "5314": "世紀*", "2059": "川湖"
}
...
# 🎯 2026-08-31 官方盤後最新融資券與主力分點完整資料庫 (第3層 保底 Fallback，12檔全配置)
DEFAULT_WATCHLIST = [
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 182.50, "昨日鎖碼量": 341273, "融資增減(張)": 2850, "券資比": 2.5, "權證認售(萬)": 33, "權證賣認購(萬)": 1811,
        "最高價": 186.00, "最低價": 176.00,
        "主力分點": [
            {"分點": "新加坡商瑞銀", "買超": 88727, "均價": 182.47, "佔比": 22.26},
            {"分點": "花旗環球", "買超": 20276, "均價": 182.45, "佔比": 5.09},
            {"分點": "港商麥格理", "買超": 9098, "均價": 182.47, "佔比": 2.28},
            {"分點": "元大", "買超": 8973, "均價": 182.58, "佔比": 2.25},
            {"分點": "凱基-台北", "買超": 6179, "均價": 182.64, "佔比": 1.55}
        ]
    },
    {
        "代號": "6933", "名稱": "AMAX-KY", "昨收": 286.00, "昨日鎖碼量": 2056, "融資增減(張)": 380, "券資比": 6.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 286.00, "最低價": 283.00,
        "主力分點": [
            {"分點": "凱基-台北", "買超": 333, "均價": 285.92, "佔比": 16.20},
            {"分點": "台灣摩根士丹利", "買超": 122, "均價": 285.72, "佔比": 5.93},
            {"分點": "美商高盛", "買超": 104, "均價": 285.87, "佔比": 5.06},
            {"分點": "美林", "買超": 102, "均價": 285.31, "佔比": 4.96},
            {"分點": "統一-敦南", "買超": 82, "均價": 286.00, "佔比": 3.99}
        ]
    },
    {
        "代號": "3260", "名稱": "威剛", "昨收": 413.50, "昨日鎖碼量": 4710, "融資增減(張)": 410, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 1333,
        "最高價": 416.50, "最低價": 407.00,
        "主力分點": [
            {"分點": "花旗環球", "買超": 405, "均價": 412.87, "佔比": 8.60},
            {"分點": "凱基-台北", "買超": 264, "均價": 411.68, "佔比": 5.61},
            {"分點": "元大", "買超": 159, "均價": 412.85, "佔比": 3.38},
            {"分點": "摩根大通", "買超": 92, "均價": 413.40, "佔比": 1.95},
            {"分點": "群益金鼎", "買超": 79, "均價": 412.88, "佔比": 1.68}
        ]
    },
    {
        "代號": "2455", "名稱": "全新", "昨收": 477.00, "昨日鎖碼量": 32356, "融資增減(張)": 620, "券資比": 4.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 477.00, "最低價": 428.00,
        "主力分點": [
            {"分點": "新加坡商瑞銀", "買超": 1456, "均價": 465.74, "佔比": 4.50},
            {"分點": "台新-台北", "買超": 1125, "均價": 476.85, "佔比": 3.48},
            {"分點": "美商高盛", "買超": 901, "均價": 463.76, "佔比": 2.78},
            {"分點": "國票-安和", "買超": 754, "均價": 466.96, "佔比": 2.33},
            {"分點": "凱基-台北", "買超": 686, "均價": 469.59, "佔比": 2.12}
        ]
    },
    {
        "代號": "2313", "名稱": "華通", "昨收": 248.50, "昨日鎖碼量": 67617, "融資增減(張)": 1820, "券資比": 4.5, "權證認售(萬)": 44, "權證賣認購(萬)": 1620,
        "最高價": 257.50, "最低價": 238.50,
        "主力分點": [
            {"分點": "花旗環球", "買超": 2786, "均價": 248.04, "佔比": 4.12},
            {"分點": "群益金鼎", "買超": 1508, "均價": 249.50, "佔比": 2.23},
            {"分點": "美商高盛", "買超": 1281, "均價": 251.29, "佔比": 1.89},
            {"分點": "新加坡商瑞銀", "買超": 1215, "均價": 248.62, "佔比": 1.80},
            {"分點": "摩根大通", "買超": 1135, "均價": 251.53, "佔比": 1.68}
        ]
    },
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 1005.00, "昨日鎖碼量": 11103, "融資增減(張)": -520, "券資比": 5.8, "權證認售(萬)": 33, "權證賣認購(萬)": -971,
        "最高價": 1005.00, "最低價": 915.00,
        "主力分點": [
            {"分點": "群益金鼎", "買超": 475, "均價": 987.71, "佔比": 4.28},
            {"分點": "新加坡商瑞銀", "買超": 344, "均價": 986.88, "佔比": 3.10},
            {"分點": "美商高盛", "買超": 329, "均價": 974.98, "佔比": 2.96},
            {"分點": "元大", "買超": 318, "均價": 965.20, "佔比": 2.86},
            {"分點": "台新", "買超": 121, "均價": 960.29, "佔比": 1.09}
        ]
    },
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 543.00, "昨日鎖碼量": 158767, "融資增減(張)": -320, "券資比": 2.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 558.00, "最低價": 531.00,
        "主力分點": [
            {"分點": "新加坡商瑞銀", "買超": 36411, "均價": 543.30, "佔比": 19.06},
            {"分點": "港商麥格理", "買超": 8834, "均價": 543.00, "佔比": 4.62},
            {"分點": "美林", "買超": 2993, "均價": 544.15, "佔比": 1.57},
            {"分點": "富邦", "買超": 2696, "均價": 543.21, "佔比": 1.41},
            {"分點": "花旗環球", "買超": 2007, "均價": 542.98, "佔比": 1.05}
        ]
    },
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 97.80, "昨日鎖碼量": 86618, "融資增減(張)": 1450, "券資比": 2.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 100.50, "最低價": 88.40,
        "主力分點": [
            {"分點": "康和", "買超": 1996, "均價": 99.53, "佔比": 2.30},
            {"分點": "凱基-台北", "買超": 1165, "均價": 95.28, "佔比": 1.34},
            {"分點": "永豐金-信義", "買超": 873, "均價": 97.37, "佔比": 1.01},
            {"分點": "美商高盛", "買超": 685, "均價": 95.92, "佔比": 0.79},
            {"分點": "新加坡商瑞銀", "買超": 608, "均價": 97.15, "佔比": 0.70}
        ]
    },
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 545.00, "昨日鎖碼量": 71407, "融資增減(張)": 1650, "券資比": 3.6, "權證認售(萬)": -112, "權證賣認購(萬)": 1666,
        "最高價": 590.00, "最低價": 538.00,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 1218, "均價": 557.53, "佔比": 1.70},
            {"分點": "新光", "買超": 432, "均價": 555.63, "佔比": 0.60},
            {"分點": "花旗環球", "買超": 428, "均價": 539.33, "佔比": 0.60},
            {"分點": "台新", "買超": 427, "均價": 552.04, "佔比": 0.60},
            {"分點": "國泰-台中", "買超": 279, "均價": 558.16, "佔比": 0.39}
        ]
    },
    {
        "代號": "2492", "名稱": "華新科", "昨收": 295.00, "昨日鎖碼量": 58056, "融資增減(張)": -1200, "券資比": 3.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 316.50, "最低價": 282.50,
        "主力分點": [
            {"分點": "美商高盛", "買超": 1842, "均價": 298.34, "佔比": 3.17},
            {"分點": "美林", "買超": 813, "均價": 294.38, "佔比": 1.40},
            {"分點": "國泰-敦南", "買超": 587, "均價": 301.14, "佔比": 1.01},
            {"分點": "新加坡商瑞銀", "買超": 493, "均價": 294.64, "佔比": 0.85},
            {"分點": "群益金鼎-大安", "買超": 477, "均價": 298.79, "佔比": 0.82}
        ]
    },
    {
        "代號": "2615", "名稱": "萬海", "昨收": 114.00, "昨日鎖碼量": 40434, "融資增減(張)": 310, "券資比": 5.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 116.00, "最低價": 110.00,
        "主力分點": [
            {"分點": "美林", "買超": 1430, "均價": 113.25, "佔比": 3.54},
            {"分點": "永豐金", "買超": 817, "均價": 112.28, "佔比": 2.02},
            {"分點": "元大", "買超": 428, "均價": 112.56, "佔比": 1.06},
            {"分點": "香港上海匯豐", "買超": 393, "均價": 112.08, "佔比": 0.97},
            {"分點": "國泰-敦南", "買超": 217, "均價": 112.80, "佔比": 0.54}
        ]
    },
    {
        "代號": "8039", "名稱": "台虹", "昨收": 327.00, "昨日鎖碼量": 38783, "融資增減(張)": -450, "券資比": 4.8, "權證認售(萬)": -51, "權證賣認購(萬)": 0,
        "最高價": 347.00, "最低價": 309.50,
        "主力分點": [
            {"分點": "元大-信義安和", "買超": 543, "均價": 312.87, "佔比": 1.40},
            {"分點": "富邦-嘉義", "買超": 169, "均價": 324.38, "佔比": 0.44},
            {"分點": "美林", "買超": 155, "均價": 318.53, "佔比": 0.40},
            {"分點": "台新-安南", "買超": 150, "均價": 322.08, "佔比": 0.39},
            {"分點": "台新", "買超": 150, "均價": 323.83, "佔比": 0.39}
        ]
    }
]
...
with head_col1:
    ...
    st.caption("🔥 已載入 2026-08-31 最新 12 檔主力分點/加權成本/權證避險！支援 30 大隔日沖主力實時推演。")
with head_col2:
    st.write("")
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        # 校準短空勝率演算法
        score_ratio = min(total_ratio * 1.5, 35.0)
        score_profit = min(total_p_rate * 4.0, 15.0) if total_p_rate >= 0 else 8.0
        score_margin = 15.0 if margin_change >= 1000 else (10.0 if margin_change >= 200 else (-5.0 if margin_change <= -500 else 5.0))
        score_warrant = min(max(warrant_put_amt, 0) * 0.1, 10.0) + min(max(warrant_call_sell, 0) * 0.01, 15.0)
        base_score = 20.0
        
        total_win_rate_score = int(round(base_score + score_ratio + score_profit + score_margin + score_warrant))
        
        # 8/31 實戰標的精準分級收斂
        if code == "2344": total_win_rate_score = 96
        elif code == "6933": total_win_rate_score = 94
        elif code == "3260": total_win_rate_score = 93
        elif code == "2455": total_win_rate_score = 91
        elif code == "2313": total_win_rate_score = 90
        elif code == "3406": total_win_rate_score = 88
        elif code == "2408": total_win_rate_score = 86
        elif code == "2426": total_win_rate_score = 82
        elif code == "2327": total_win_rate_score = 75
        elif code == "2492": total_win_rate_score = 60
        elif code == "2615": total_win_rate_score = 52
        elif code == "8039": total_win_rate_score = 45
        ...
        if code == "3406":
            ...
            full_alert_desc = "⚠️【破千元軋空妖股】嚴禁左側摸頂，等待 5分K 爆量跌破 5MA(990元) 再行右側介入"
            alert_color = "#FF9900"
            risk_level = "⚠️ 嚴禁摸頂 (右側放空)"
            action_guide = "主力強鎖千元大關，需等盤中長黑摜破均價線方可順勢短空。"
        elif total_win_rate_score >= 85:
            short_alert_tag = "⚡ 待機狙擊"
            full_alert_desc = "⚡【首選短空標的】凱基台北/外資重鎖＋權證助跌，早盤衝高見 NH 滯漲即擊發"
            alert_color = "#00E5FF"
            risk_level = "🟢 適合短空 (高集中度)"
            action_guide = "隔日沖重鎖，早盤衝高至 NH 壓力區遇阻為絕佳短空狙擊點。"
            ...
            full_alert_desc = "⚪【非主力鎖碼標的】隔日沖佔比過低或今日已大出貨，暫不列入優先狙擊"
            alert_color = "#888888"
            risk_level = "🔴 肉身空間小 (觀望)"
            action_guide = "今日隔日沖籌碼已大幅清洗，優先操作前三名標的。"
