...
# 🎯 2026-09-03 盤後官方融資券 × 權證小哥避險 × 主力分點最新校準資料庫 (8039修正為-2956)
DEFAULT_WATCHLIST = [
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 169.00, "昨日鎖碼量": 161326, "融資增減(張)": -681, "券資比": 2.5, "權證認售(萬)": 0, "權證賣認購(萬)": 1730,
        "最高價": 185.50, "最低價": 168.00,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 1640, "均價": 176.38, "佔比": 1.02},
            {"分點": "美林", "買超": 1519, "均價": 179.49, "佔比": 0.94},
            {"分點": "花旗環球", "買超": 767, "均價": 172.71, "佔比": 0.48},
            {"分點": "永豐金-匯立", "買超": 705, "均價": 177.72, "佔比": 0.44},
            {"分點": "富邦-南屯", "買超": 503, "均價": 174.83, "佔比": 0.31}
        ]
    },
    {
        "代號": "3260", "名稱": "威剛", "昨收": 395.00, "昨日鎖碼量": 10472, "融資增減(張)": 0, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 419.50, "最低價": 394.00,
        "主力分點": [
            {"分點": "永豐金", "買超": 201, "均價": 406.80, "佔比": 1.92},
            {"分點": "玉山-大里", "買超": 196, "均價": 409.89, "佔比": 1.87},
            {"分點": "兆豐-南京", "買超": 131, "均價": 407.58, "佔比": 1.25}
        ]
    },
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 477.50, "昨日鎖碼量": 123832, "融資增減(張)": 70, "券資比": 3.0, "權證認售(萬)": 54, "權證賣認購(萬)": 0,
        "最高價": 539.00, "最低價": 477.50,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 1822, "均價": 504.88, "佔比": 1.47},
            {"分點": "富邦-虎尾", "買超": 847, "均價": 501.36, "佔比": 0.68},
            {"分點": "新光", "買超": 642, "均價": 501.85, "佔比": 0.52},
            {"分點": "永豐金", "買超": 567, "均價": 498.41, "佔比": 0.46}
        ]
    },
    {
        "代號": "3189", "名稱": "景碩", "昨收": 775.00, "昨日鎖碼量": 27084, "融資增減(張)": 464, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 882.00, "最低價": 775.00,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 445, "均價": 821.17, "佔比": 1.64},
            {"分點": "群益金鼎-大安", "買超": 280, "均價": 817.03, "佔比": 1.03},
            {"分點": "台新", "買超": 109, "均價": 815.92, "佔比": 0.40}
        ]
    },
    {
        "代號": "2313", "名稱": "華通", "昨收": 236.00, "昨日鎖碼量": 25802, "融資增減(張)": -2383, "券資比": 4.0, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 255.00, "最低價": 236.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 2441, "均價": 242.14, "佔比": 9.40},
            {"分點": "美林", "買超": 1469, "均價": 245.54, "佔比": 5.66},
            {"分點": "凱基-台北", "買超": 848, "均價": 243.17, "佔比": 3.27}
        ]
    },
    {
        "代號": "8039", "名稱": "台虹", "昨收": 293.00, "昨日鎖碼量": 39244, "融資增減(張)": -2956, "券資比": 4.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 318.50, "最低價": 291.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": 974, "均價": 300.29, "佔比": 2.48},
            {"分點": "美商高盛", "買超": 690, "均價": 300.27, "佔比": 1.76},
            {"分點": "美林", "買超": 502, "均價": 301.11, "佔比": 1.28},
            {"分點": "新加坡商瑞銀", "買超": 364, "均價": 299.56, "佔比": 0.93}
        ]
    },
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 511.00, "昨日鎖碼量": 34250, "融資增減(張)": -1079, "券資比": 3.6, "權證認售(萬)": 39, "權證賣認購(萬)": 0,
        "最高價": 545.00, "最低價": 511.00,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 521, "均價": 529.90, "佔比": 1.52},
            {"分點": "港商麥格理", "買超": 250, "均價": 529.52, "佔比": 0.73},
            {"分點": "凱基-台北", "買超": 238, "均價": 529.66, "佔比": 0.69}
        ]
    },
    {
        "代號": "2492", "名稱": "華新科", "昨收": 271.50, "昨日鎖碼量": 22304, "融資增減(張)": -123, "券資比": 3.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 296.00, "最低價": 270.00,
        "主力分點": [
            {"分點": "國泰-敦南", "買超": 292, "均價": 283.49, "佔比": 1.31},
            {"分點": "國泰-台中", "買超": 121, "均價": 284.64, "佔比": 0.54}
        ]
    },
    {
        "代號": "3037", "名稱": "欣興", "昨收": 923.00, "昨日鎖碼量": 33450, "融資增減(張)": -341, "券資比": 5.0, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 1005.00, "最低價": 923.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": 1493, "均價": 943.43, "佔比": 4.46},
            {"分點": "新加坡商瑞銀", "買超": 856, "均價": 944.37, "佔比": 2.56}
        ]
    },
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 991.00, "昨日鎖碼量": 2416, "融資增減(張)": -228, "券資比": 5.4, "權證認售(萬)": -75, "權證賣認購(萬)": 0,
        "最高價": 1070.00, "最低價": 990.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 258, "均價": 1009.95, "佔比": 10.68},
            {"分點": "台灣摩根士丹利", "買超": 179, "均價": 1011.10, "佔比": 7.41}
        ]
    },
    {
        "代號": "2455", "名稱": "全新", "昨收": 525.00, "昨日鎖碼量": 21442, "融資增減(張)": -1274, "券資比": 6.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 555.00, "最低價": 520.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 865, "均價": 539.62, "佔比": 4.03},
            {"分點": "美林", "買超": 671, "均價": 539.57, "佔比": 3.13}
        ]
    },
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 95.00, "昨日鎖碼量": 52236, "融資增減(張)": -2242, "券資比": 2.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 107.50, "最低價": 95.00,
        "主力分點": [
            {"分點": "新加坡商瑞銀", "買超": 807, "均價": 97.55, "佔比": 1.54},
            {"分點": "美林", "買超": 798, "均價": 97.45, "佔比": 1.53}
        ]
    }
]
...
# 強制重整 watchlist 快取確保最新 9/3 官方數據生效
...
with head_col1:
    ...
    st.caption("🔥 2026-09-03 盤後官方融資融券與避險籌碼校準完畢！準備 09/04 (Round 2) 實戰狙擊。")
with head_col2:
    st.write("")
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        prev_close = round(close_price * 1.05, 2)
        ...
        # 校準短空勝率演算法 (9/3 官方最新修正版：8039融資減移至觀察，華邦電、威剛、南亞科晉升首選)
        if code == "2344": total_win_rate_score = 98     # 權證狂拋 1730 萬認購，自營商現貨砍倉
        elif code == "3260": total_win_rate_score = 96   # 主力狂倒 33%，破 400 收最低
        elif code == "2408": total_win_rate_score = 94   # 外資倒逾萬張，權證認售增買 54 萬
        elif code == "3189": total_win_rate_score = 91   # 跌 8.5% 融資逆勢大增 464 張，多殺多
        elif code == "2313": total_win_rate_score = 88   # 高盛美林凱基台北買超深套
        elif code == "2327": total_win_rate_score = 84   # 融資大減 1079 張，收最低
        elif code == "2492": total_win_rate_score = 80
        elif code == "8039": total_win_rate_score = 75   # 融資大退 -2956 張浮額洗淨，降至次選
        elif code == "3037": total_win_rate_score = 72
        elif code == "3406": total_win_rate_score = 65   # 認售回補，外資逆買千元護盤
        elif code == "2426": total_win_rate_score = 50   # 跌 9.09% 融資減 2242，空間收窄
        elif code == "2455": total_win_rate_score = 45   # 抗跌外資買，維持禁空
        else: total_win_rate_score = 60

        total_win_rate_score = max(min(total_win_rate_score, 99), 10)

        # 盤前訊號定調
        if code in ["2455", "2426"]:
            short_alert_tag = "🛑 NO SHORT"
            full_alert_desc = f"🛑【風控防禦】{name} 籌碼沉澱或跌幅已近跌停，盈虧比不佳嚴禁盲目追空"
            alert_color = "#FF0000"
            risk_level = "🔴 空間收窄 (嚴禁追空)"
            action_guide = "盈虧比收窄或有外資護盤，嚴格迴避。"
        elif code == "3406":
            short_alert_tag = "⚠️ 妖股觀望"
            full_alert_desc = "⚠️【千元關卡拉鋸】認售權證獲利退場，防外資高盛大摩早盤反手軋空"
            alert_color = "#FF9900"
            risk_level = "⚠️ 嚴禁摸頂 (觀望)"
            action_guide = "不搶第一根，等待盤中失守均價線再作右側確認。"
        elif total_win_rate_score >= 90:
            short_alert_tag = "⚡ 首選狙擊"
            full_alert_desc = f"⚡【核心空方標的】散戶融資逆勢接刀/權證避險出清，5分K實體跌破順勢開空"
            alert_color = "#00E5FF"
            risk_level = "🟢 適合短空 (高集中度)"
            action_guide = "主力大量套牢，早盤衝高不過昨收或破昨低即順勢擊發。"
        else:
        ...
        status_color = "#3399FF"
        margin_status = "🔥 融資暴增 (散戶抄底/易多殺多)" if margin_change >= 400 else ("💧 融資退潮 (散戶離場/籌碼沉澱)" if margin_change <= -400 else "⚪ 融資平穩")
...
if exclude_high_risk:
    mask = mask & (~df_raw["軋空風險評級"].str.contains("空間收窄"))
