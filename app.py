...
HISTORICAL_ROUNDS = [
    ...
    },
    {
        ...
        "gem_pnl": 45000, "gem_net": 1665595, "gem_targets": "6173 信昌電(期 T1命中 +9.5點), 2327 國巨*(期 尾盤強平 +3.5點)",
        "gpt_pnl": 0, "gpt_net": 1289681, "gpt_targets": "0部位 (門檻設定較深未觸發，空手防守)",
        "spread": 375914, "review": "大盤衝 47,038 後跳水！Gemini 捕捉信昌電隔日沖踩踏摜破 312 命中 T1(302)，國巨尾盤強平擴大戰果；GPT 門檻過深無觸發。"
    }
]
