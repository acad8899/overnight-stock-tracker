...
DATA_VERSION = "20260911_R8_LOCKED_V2"

# 期交所個股期貨支援名單（已剔除 2426 鼎元，正式納入 6173 信昌電）
STOCK_FUTURES_SET = {
    "6173", "8039", "2408", "3260", "2449", "3231", "2327", "2376", "6488", "2313", "2492",
    "2330", "2317", "2454", "2382", "2603", "2609", "2344", "3037", "2368", "3017",
    "2383", "1519", "8210", "2059", "4551", "5289", "8299", "3406",
    "2615", "5314", "2489", "3006", "2337", "8046", "2455", "3189",
    "3374", "6239"
}

# 內建台股代號與名稱對照字典
STOCK_NAME_DICT = {
    "2344": "華邦電", "2426": "鼎元", "2313": "華通", "2327": "國巨*", "3406": "玉晶光",
    "2492": "華新科", "2408": "南亞科", "8039": "台虹", "3189": "景碩", "3037": "欣興",
    "2455": "全新", "3260": "威剛", "6173": "信昌電", "2303": "聯電", "3008": "大立光", 
    "5274": "信驊", "2330": "台積電", "2317": "鴻海", "2454": "聯發科", "2382": "廣達", "2603": "長榮"
}

NAME_TO_CODE_DICT = {v: k for k, v in STOCK_NAME_DICT.items()}
TPEX_STOCKS = {"3260", "6488", "8299", "5289", "3211", "5483", "8112", "6213", "5314", "3105", "3374", "5274", "6173"}
...
BROKER_DATA_CATALOG = [
    ...
    [11, "雙北核心", "國票-敦北法人", "隔日沖關鍵旗艦", "專精鎖定隔日沖強勢股，早盤市價反手倒出", "09:00～09:20 集中獲利了結", "開盤若反彈無力跌破前低即果斷開空"]
]

TARGET_BROKERS = [row[2] for row in BROKER_DATA_CATALOG]

# 🎯 2026-09-11 盤後官方融資券 × 權證避險 × 主力分點最新校準資料庫 (Round 8 法定 12 檔)
DEFAULT_WATCHLIST = [
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 97.10, "昨日鎖碼量": 50681, "融資增減(張)": -602, "券資比": 3.5, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 101.50, "最低價": 92.40,
        "主力分點": [
            {"分點": "康和", "買超": 993, "均價": 98.96, "佔比": 1.96},
            {"分點": "國票-敦北法人", "買超": 893, "均價": 99.64, "佔比": 1.76},
            {"分點": "美商高盛", "買超": 567, "均價": 98.11, "佔比": 1.12},
            {"分點": "摩根大通", "買超": 566, "均價": 96.85, "佔比": 1.12},
            {"分點": "兆豐", "買超": 500, "均價": 100.19, "佔比": 0.99},
            {"分點": "元大", "買超": 475, "均價": 98.53, "佔比": 0.94},
            {"分點": "凱基-台北", "買超": -330, "均價": 97.23, "佔比": -0.65},
            {"分點": "富邦", "買超": -263, "均價": 99.47, "佔比": -0.52}
        ]
    },
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 171.50, "昨日鎖碼量": 74789, "融資增減(張)": 872, "券資比": 2.5, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 173.50, "最低價": 170.50,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": -12087, "均價": 172.09, "佔比": -16.16},
            {"分點": "美商高盛", "買超": -6085, "均價": 172.01, "佔比": -8.14},
            {"分點": "元大", "買超": -4960, "均價": 172.31, "佔比": -6.63},
            {"分點": "摩根大通", "買超": -3487, "均價": 171.97, "佔比": -4.66},
            {"分點": "凱基-台北", "買超": -2401, "均價": 172.12, "佔比": -3.21},
            {"分點": "國泰-敦南", "買超": 1511, "均價": 172.19, "佔比": 2.02},
            {"分點": "港商麥格理", "買超": 1401, "均價": 171.84, "佔比": 1.87}
        ]
    },
    {
        "代號": "3260", "名稱": "威剛", "昨收": 402.50, "昨日鎖碼量": 5226, "融資增減(張)": -198, "券資比": 3.6, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 406.00, "最低價": 396.50,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": -548, "均價": 400.36, "佔比": -10.49},
            {"分點": "摩根大通", "買超": -502, "均價": 398.72, "佔比": -9.61},
            {"分點": "凱基-台北", "買超": -263, "均價": 398.66, "佔比": -5.03},
            {"分點": "美商高盛", "買超": -225, "均價": 400.49, "佔比": -4.31},
            {"分點": "合庫", "買超": 255, "均價": 400.95, "佔比": 4.88},
            {"分點": "國泰", "買超": 138, "均價": 402.85, "佔比": 2.64}
        ]
    },
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 493.00, "昨日鎖碼量": 38482, "融資增減(張)": -513, "券資比": 2.7, "權證認售(萬)": -236, "權證賣認購(萬)": 0,
        "最高價": 498.00, "最低價": 490.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": -5044, "均價": 493.86, "佔比": -13.11},
            {"分點": "美商高盛", "買超": -3368, "均價": 493.88, "佔比": -8.75},
            {"分點": "元大", "買超": -2396, "均價": 494.04, "佔比": -6.23},
            {"分點": "摩根大通", "買超": -1908, "均價": 493.86, "佔比": -4.96},
            {"分點": "凱基-台北", "買超": -1114, "均價": 493.83, "佔比": -2.89},
            {"分點": "美林", "買超": 549, "均價": 494.29, "佔比": 1.43}
        ]
    },
    {
        "代號": "8039", "名稱": "台虹", "昨收": 272.00, "昨日鎖碼量": 22099, "融資增減(張)": 486, "券資比": 5.8, "權證認售(萬)": -119, "權證賣認購(萬)": 0,
        "最高價": 280.00, "最低價": 270.50,
        "主力分點": [
            {"分點": "摩根大通", "買超": -1085, "均價": 274.49, "佔比": -4.91},
            {"分點": "凱基-台北", "買超": -313, "均價": 275.26, "佔比": -1.42},
            {"分點": "群益金鼎", "買超": -193, "均價": 274.20, "佔比": -0.87},
            {"分點": "台灣摩根士丹利", "買超": 650, "均價": 274.21, "佔比": 2.94},
            {"分點": "新加坡商瑞銀", "買超": 288, "均價": 274.37, "佔比": 1.30}
        ]
    },
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 544.00, "昨日鎖碼量": 35558, "融資增減(張)": -1613, "券資比": 3.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 570.00, "最低價": 544.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": -4045, "均價": 554.41, "佔比": -11.38},
            {"分點": "元大", "買超": -2367, "均價": 557.14, "佔比": -6.66},
            {"分點": "凱基-台北", "買超": -838, "均價": 555.71, "佔比": -2.36},
            {"分點": "富邦-新店", "買超": -716, "均價": 556.85, "佔比": -2.01},
            {"分點": "台灣摩根士丹利", "買超": 1368, "均價": 556.10, "佔比": 3.85},
            {"分點": "港商野村", "買超": 844, "均價": 560.51, "佔比": 2.37}
        ]
    },
    {
        "代號": "2492", "名稱": "華新科", "昨收": 311.50, "昨日鎖碼量": 57397, "融資增減(張)": 145, "券資比": 3.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 340.00, "最低價": 310.00,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": -2488, "均價": 324.77, "佔比": -4.33},
            {"分點": "元大", "買超": -1107, "均價": 329.46, "佔比": -1.93},
            {"分點": "新加坡商瑞銀", "買超": -1003, "均價": 327.58, "佔比": -1.75},
            {"分點": "富邦", "買超": -736, "均價": 328.49, "佔比": -1.28},
            {"分點": "港商野村", "買超": -709, "均價": 324.35, "佔比": -1.24},
            {"分點": "國泰-敦南", "買超": 393, "均價": 326.56, "佔比": 0.68}
        ]
    },
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 1060.00, "昨日鎖碼量": 10717, "融資增減(張)": -142, "券資比": 4.5, "權證認售(萬)": 110, "權證賣認購(萬)": 2018,
        "最高價": 1140.00, "最低價": 1000.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": -504, "均價": 1092.12, "佔比": -4.70},
            {"分點": "摩根大通", "買超": -377, "均價": 1080.63, "佔比": -3.52},
            {"分點": "美林", "買超": -211, "均價": 1091.31, "佔比": -1.97},
            {"分點": "凱基-台北", "買超": -173, "均價": 1095.62, "佔比": -1.61},
            {"分點": "永豐金", "買超": 312, "均價": 1088.45, "佔比": 2.91},
            {"分點": "統一", "買超": 239, "均價": 1082.57, "佔比": 2.23}
        ]
    },
    {
        "代號": "2313", "名稱": "華通", "昨收": 221.50, "昨日鎖碼量": 9352, "融資增減(張)": -413, "券資比": 4.0, "權證認售(萬)": -63, "權證賣認購(萬)": 0,
        "最高價": 224.00, "最低價": 218.50,
        "主力分點": [
            {"分點": "元大", "買超": -197, "均價": 221.94, "佔比": -2.11},
            {"分點": "合庫-自強", "買超": -190, "均價": 222.21, "佔比": -2.03},
            {"分點": "摩根大通", "買超": -151, "均價": 221.81, "佔比": -1.61},
            {"分點": "國票-安和", "買超": -102, "均價": 221.32, "佔比": -1.09},
            {"分點": "新加坡商瑞銀", "買超": 103, "均價": 222.73, "佔比": 1.10},
            {"分點": "美林", "買超": 100, "均價": 221.35, "佔比": 1.07}
        ]
    },
    {
        "代號": "3037", "名稱": "欣興", "昨收": 977.00, "昨日鎖碼量": 11445, "融資增減(張)": -36, "券資比": 4.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 990.00, "最低價": 958.00,
        "主力分點": [
            {"分點": "港商麥格理", "買超": -506, "均價": 972.37, "佔比": -4.42},
            {"分點": "統一", "買超": -248, "均價": 974.73, "佔比": -2.17},
            {"分點": "國票-敦北法人", "買超": 395, "均價": 983.07, "佔比": 3.45},
            {"分點": "摩根大通", "買超": 297, "均價": 981.31, "佔比": 2.60},
            {"分點": "新加坡商瑞銀", "買超": 243, "均價": 979.51, "佔比": 2.12}
        ]
    },
    {
        "代號": "3189", "名稱": "景碩", "昨收": 822.00, "昨日鎖碼量": 8394, "融資增減(張)": 306, "券資比": 4.0, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 833.00, "最低價": 806.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 700, "均價": 817.41, "佔比": 8.34},
            {"分點": "富邦-新店", "買超": 218, "均價": 823.50, "佔比": 2.60},
            {"分點": "元大", "買超": 192, "均價": 823.04, "佔比": 2.29},
            {"分點": "凱基-台北", "買超": -368, "均價": 814.91, "佔比": -4.38},
            {"分點": "摩根大通", "買超": -181, "均價": 813.27, "佔比": -2.16}
        ]
    },
    {
        "代號": "2455", "名稱": "全新", "昨收": 515.00, "昨日鎖碼量": 1842, "融資增減(張)": -95, "券資比": 5.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 527.00, "最低價": 499.50,
        "主力分點": [
            {"分點": "台灣摩根士丹利", "買超": 473, "均價": 515.32, "佔比": 25.68},
            {"分點": "富邦", "買超": 196, "均價": 512.87, "佔比": 10.64},
            {"分點": "統一", "買超": -308, "均價": 514.64, "佔比": -16.72},
            {"分點": "永豐金-匯立", "買超": -136, "均價": 512.90, "佔比": -7.38}
        ]
    }
]
...
if st.session_state.get("APP_DATA_VERSION") != DATA_VERSION:
    ...
    st.session_state["selected_stock_code"] = "2426"

head_col1, head_col2 = st.columns([4, 1])
with head_col1:
    st.title("🎯 每日隔日沖主力短空雷達 (全自動AI智慧旗艦版)")
    st.caption("🔥 2026-09-11 盤後官方融資券 × 權證避險 × 分點資料庫完整封存！9/14 Round 8 決戰鎖定。")
with head_col2:
    st.write("")
    if st.button("🔄 強制重整 R8 盤後資料庫", use_container_width=True):
        st.session_state["custom_watchlist"] = DEFAULT_WATCHLIST
        st.session_state["selected_stock_code"] = "2426"
        st.cache_data.clear()
        st.rerun()
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        # 🎯 2026/09/11 盤後官方短空勝率演算法核心標定 (9/14 R8 實戰)
        if code == "2426": total_win_rate_score = 99     # 康和+國票敦北法人隔日沖鎖碼近1900張 + 融資大洗602張 (早盤必現倒貨潮)
        elif code == "2344": total_win_rate_score = 98   # 大摩狂倒1.2萬張(佔16%) + 外資合計大砍2.8萬張 + 散戶融資逆勢暴增872張接刀
        elif code == "3260": total_win_rate_score = 96   # 大摩小摩連續兩日合砍逾20%籌碼 + 外資全線出逃 + 融資續退
        elif code == "2408": total_win_rate_score = 95   # 大摩高盛合砍8400張破500關卡 + 認售權證賣超全市場第一(-236萬)
        elif code == "8039": total_win_rate_score = 92   # 散戶融資大增486張抄底 + 小摩續倒1085張 + 認售避險賣超-119萬
        elif code == "2327": total_win_rate_score = 88   # 高盛清倉式大倒4045張 + 融資大退1613張 + 破頭部頸線收全日最低544
        elif code == "2492": total_win_rate_score = 85   # 長黑重挫近7% + 外資集體出脫逾6600張 + 融資追高浮額深套
        elif code == "3406": total_win_rate_score = 78   # 認購大買2018萬 vs 認售買超110萬 + 外資高盛小摩逢高大倒貨壓回
        elif code == "2313": total_win_rate_score = 65   # 量縮跌破均線，主力券商持續出脫，沿5MA偏弱整理
        elif code == "3037": total_win_rate_score = 45   # 國票敦北買超第一(+395) vs 外資回補千張，高檔多空分歧列觀察
        elif code == "3189": total_win_rate_score = 15   # 美商高盛連續三日集中大買(+700張)，外資主力高度鎖碼，嚴禁做空
        elif code == "2455": total_win_rate_score = 10   # 台灣摩根士丹利單一分點買超佔比高達25.68%，強烈護盤，嚴禁摸頂
        else: total_win_rate_score = 50

        total_win_rate_score = max(min(total_win_rate_score, 99), 10)

        # 盤前信號定調
        if code in ["2455", "3189"]:
            short_alert_tag = "🛑 NO SHORT"
            full_alert_desc = f"🛑【極高軋空/外資鎖碼】{name} 外資主力集中買超鎖碼，嚴禁逆勢放空！"
            alert_color = "#FF0000"
            risk_level = "🔴 極高軋空 (嚴禁做空)"
            action_guide = "主力大舉鎖碼護盤，嚴禁逆勢摸頂。"
        elif total_win_rate_score >= 90:
            short_alert_tag = "⚡ 首選狙擊"
            full_alert_desc = f"⚡【核心空方破綻】隔日沖倒貨 / 外資暴砍踩踏 / 融資套牢，5分K實體跌破順勢開空"
            alert_color = "#00E5FF"
            risk_level = "🟢 適合短空 (出貨明確)"
            action_guide = "主力倒貨或外資集體踐踏，跌破關鍵門檻順勢擊發。"
        else:
        ...
        status_color = "#3399FF"
        margin_status = "🔥 融資暴增 (散戶接刀/多殺多)" if margin_change >= 800 else ("🔥 融資增加 (浮額沉重)" if margin_change >= 100 else ("💧 融資大退 (散戶斷頭/主力洗淨)" if margin_change <= -1000 else ("💧 融資退潮 (散戶離場)" if margin_change <= -200 else "⚪ 融資平穩")))
...
c2.metric("🎯 監控短空鎖碼標的", f"{len(df_display)} 檔 (R8 法定全數到位)")
...
with left_side:
    ...
    current_code = str(st.session_state.get("selected_stock_code", "2426"))
    current_idx = 0
