...
# 🎯 8/26 盤後 10 檔官方真實分點資料庫（嚴格依股價分層動態過濾）
DEFAULT_WATCHLIST = [
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 690.00, "昨日鎖碼量": 9354, "融資增減(張)": 778, "券資比": 14.8, "權證認售(萬)": 127,
        "主力分點": [
            {"分點": "宏遠", "買超": 229, "均價": 755.89, "佔比": 2.45},
            {"分點": "台新", "買超": 202, "均價": 750.51, "佔比": 2.16},
            {"分點": "統一", "買超": 152, "均價": 746.01, "佔比": 1.62}
        ]
    },
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 90.80, "昨日鎖碼量": 82191, "融資增減(張)": 3973, "券資比": 7.2, "權證認售(萬)": 15,
        "主力分點": [
            {"分點": "富邦", "買超": 5176, "均價": 99.54, "佔比": 6.30},
    ...
    },
    {
        ...
        "主力分點": [
            ...
            {"分點": "美林", "買超": 924, "均價": 181.07, "佔比": 4.39},
            {"分點": "台灣摩根士丹利", "買超": 747, "均價": 179.46, "佔比": 3.55},
            {"分點": "元大", "買超": 417, "均價": 180.25, "佔比": 1.98},
            {"分點": "港商野村", "買超": 388, "均價": 180.52, "佔比": 1.85}
        ]
    },
    {
...
with head_col1:
    ...
    st.caption("🔥 已套用【股價分層動態風控門檻】，精準鎖定實質大資金，過濾低價散單雜訊！")
with head_col2:
    st.write("")
