...
# 內建常用台股代號與名稱對照字典
STOCK_NAME_DICT = {
    "2609": "陽明", "2615": "萬海", "8039": "台虹", "2489": "瑞軒", "3231": "緯創",
    ...
    "8210": "勤誠", "3661": "世芯-KY", "2059": "川湖", "3443": "創意", "4551": "智伸科",
    "5289": "宜鼎", "8299": "群聯", "3008": "大立光", "5314": "世紀*", "3006": "晶豪科"
}
...
# 🎯 8/25 盤後官方 100% 真實分點、買超張數、真實均價與權證避險庫
DEFAULT_WATCHLIST = [
    {
        "代號": "2609", "名稱": "陽明", "昨收": 63.60, "昨日鎖碼量": 192985, "融資增減(張)": 0, "券資比": 8.2, "權證認售(萬)": 88,
        "主力分點": [
            {"分點": "美商高盛", "買超": 6065, "均價": 64.78, "佔比": 3.14},
            {"分點": "美商美林", "買超": 2784, "均價": 64.72, "佔比": 1.44},
            {"分點": "摩根大通", "買超": 2427, "均價": 65.55, "佔比": 1.26},
            {"分點": "凱基-台北", "買超": 2332, "均價": 64.76, "佔比": 1.21}
        ]
    },
    {
        "代號": "2615", "名稱": "萬海", "昨收": 126.50, "昨日鎖碼量": 90375, "融資增減(張)": 0, "券資比": 9.5, "權證認售(萬)": 144,
        "主力分點": [
    ...
    {
        "代號": "8039", "名稱": "台虹", "昨收": 265.00, "昨日鎖碼量": 60294, "融資增減(張)": 0, "券資比": 14.5, "權證認售(萬)": 52,
        "主力分點": [
    ...
    {
        "代號": "2489", "名稱": "瑞軒", "昨收": 36.90, "昨日鎖碼量": 70188, "融資增減(張)": 0, "券資比": 11.2, "權證認售(萬)": 0,
        "主力分點": [
    ...
    {
        "代號": "3231", "名稱": "緯創", "昨收": 175.50, "昨日鎖碼量": 56952, "融資增減(張)": 0, "券資比": 6.8, "權證認售(萬)": 36,
        "主力分點": [
    ...
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 657.00, "昨日鎖碼量": 2387, "融資增減(張)": 0, "券資比": 13.2, "權證認售(萬)": 0,
        "主力分點": [
    ...
    {
        "代號": "2449", "名稱": "京元電子", "昨收": 239.00, "昨日鎖碼量": 11213, "融資增減(張)": 0, "券資比": 7.1, "權證認售(萬)": -66,
        "主力分點": [
    ...
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 501.00, "昨日鎖碼量": 66841, "融資增減(張)": 0, "券資比": 6.2, "權證認售(萬)": -87,
        "主力分點": [
    ...
    {
        "代號": "3260", "名稱": "威剛", "昨收": 438.50, "昨日鎖碼量": 17221, "融資增減(張)": 0, "券資比": 5.0, "權證認售(萬)": -139,
        "主力分點": [
    ...
    {
        "代號": "6488", "名稱": "環球晶", "昨收": 1010.00, "昨日鎖碼量": 9687, "融資增減(張)": 0, "券資比": 9.5, "權證認售(萬)": 29,
        "主力分點": [
...
if "custom_watchlist" not in st.session_state or st.session_state.get("custom_watchlist", [{}])[0].get("代號") != "2609":
...
with head_col1:
    ...
    st.caption("🔥 頂部單行狀態列隨游標100%全圖層連動、已校準 8/25 盤後真實券商買超與成交均價。")
with head_col2:
    st.write("")
...
with st.expander("🛠️ 點此展開／收合【標的名單管理與風控設定】", expanded=False):
    ...
    with f_col1:
        min_ratio = st.slider("主力合計佔比 (%) 門檻：", min_value=1, max_value=30, value=1, step=1)
    with f_col2:
