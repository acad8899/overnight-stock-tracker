...
with head_col1:
    ...
    st.caption("🔥 僅抓取 30 大隔日沖主力名冊，剔除雜訊分點，聚焦高頻開高倒貨慣性。")
with head_col2:
    st.write("")
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        enhanced_list.append({
            ...
            "隔日沖分點清單": "、".join(broker_names_list) if broker_names_list else "無特定隔日沖買超",
...
def check_broker_overlap(broker_str, selected_list):
    if not selected_list or broker_str == "無特定隔日沖買超":
        return True
