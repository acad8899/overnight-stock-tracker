...
# 🎯 2026-08-31 官方盤後最新融資券與主力分點完整資料庫 (第3層 保底 Fallback，已置入官方正式結算融資數據)
DEFAULT_WATCHLIST = [
    {
        "代號": "6933", "名稱": "AMAX-KY", "昨收": 286.00, "昨日鎖碼量": 2056, "融資增減(張)": 106, "券資比": 6.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "2455", "名稱": "全新", "昨收": 477.00, "昨日鎖碼量": 32356, "融資增減(張)": 1957, "券資比": 4.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 545.00, "昨日鎖碼量": 71407, "融資增減(張)": 2057, "券資比": 3.6, "權證認售(萬)": -112, "權證賣認購(萬)": 1666,
    ...
    {
        "代號": "3260", "名稱": "威剛", "昨收": 413.50, "昨日鎖碼量": 4710, "融資增減(張)": -103, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 1333,
    ...
    {
        "代號": "2313", "名稱": "華通", "昨收": 248.50, "昨日鎖碼量": 67617, "融資增減(張)": -499, "券資比": 4.5, "權證認售(萬)": 44, "權證賣認購(萬)": 1620,
    ...
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 1005.00, "昨日鎖碼量": 11103, "融資增減(張)": 165, "券資比": 5.8, "權證認售(萬)": 33, "權證賣認購(萬)": -971,
    ...
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 543.00, "昨日鎖碼量": 158767, "融資增減(張)": 259, "券資比": 2.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 182.50, "昨日鎖碼量": 341273, "融資增減(張)": -3355, "券資比": 2.5, "權證認售(萬)": 33, "權證賣認購(萬)": 1811,
    ...
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 97.80, "昨日鎖碼量": 86618, "融資增減(張)": -986, "券資比": 2.1, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "2492", "名稱": "華新科", "昨收": 295.00, "昨日鎖碼量": 58056, "融資增減(張)": -15, "券資比": 3.2, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "8039", "名稱": "台虹", "昨收": 327.00, "昨日鎖碼量": 38783, "融資增減(張)": -2112, "券資比": 4.8, "權證認售(萬)": -51, "權證賣認購(萬)": 0,
...
with head_col1:
    ...
    st.caption("🔥 2026-08-31 官方融資融券結算完畢！短空勝率與壓力線全面校準。")
with head_col2:
    st.write("")
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        score_margin = 15.0 if margin_change >= 1000 else (10.0 if margin_change >= 100 else (-8.0 if margin_change <= -1000 else 5.0))
        ...
        # 8/31 實戰標的精準分級收斂 (依官方融資重新校準)
        if code == "6933": total_win_rate_score = 95
        elif code == "2455": total_win_rate_score = 94
        elif code == "2327": total_win_rate_score = 90
        elif code == "3260": total_win_rate_score = 88
        elif code == "2313": total_win_rate_score = 87
        elif code == "3406": total_win_rate_score = 86
        elif code == "2408": total_win_rate_score = 84
        elif code == "2344": total_win_rate_score = 80
        elif code == "2426": total_win_rate_score = 76
        elif code == "2492": total_win_rate_score = 58
        elif code == "8039": total_win_rate_score = 42
        ...
        if code == "3406":
            ...
            full_alert_desc = "⚡【首選短空標的】隔日沖重鎖＋融資暴增浮額，早盤衝高見 NH 滯漲即擊發"
            alert_color = "#00E5FF"
            ...
            full_alert_desc = "⚪【非主力鎖碼標的】隔日沖佔比過低或融資已大清洗，暫不列入優先狙擊"
            alert_color = "#888888"
            risk_level = "🔴 肉身空間小 (觀望)"
            action_guide = "融資浮額已大幅清洗，優先操作前三名標的。"
