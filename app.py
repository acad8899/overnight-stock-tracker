...
STOCK_NAME_DICT = {
    ...
    "3037": "欣興", "2368": "金像電", "3017": "奇鋐", "2383": "台光電", "5314": "世紀*", "2059": "川湖"
}
...
# 🎯 2026-08-31 官方盤後最新融資券與主力分點完整資料庫 (第3層 保底 Fallback，已置換 2327 國巨*)
DEFAULT_WATCHLIST = [
    {
...
with head_col1:
    ...
    st.caption("🔥 已載入 2026-08-31 最新主力分點/加權成本/權證避險！支援 30 大隔日沖主力實時推演。")
with head_col2:
    st.write("")
