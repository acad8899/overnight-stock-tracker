...
# 期交所個股期貨支援名單 (保留 3406 玉晶光，過濾大於 1200 元標的)
STOCK_FUTURES_SET = {
...
STOCK_NAME_DICT = {
    ...
    "6239": "力成", "2368": "金像電", "8039": "台虹", "3374": "精材", "3260": "威剛",
    "2615": "萬海", "6933": "AMAX-KY", "2449": "京元電子", "3231": "緯創", "2489": "瑞軒",
    "6488": "環球晶", "2376": "技嘉", "2330": "台積電", "2317": "鴻海", "2454": "聯發科",
    "2382": "廣達", "2603": "長榮", "3017": "奇鋐", "2383": "台光電", "5314": "世紀*",
    "2059": "川湖"
}
...
# 🎯 2026-09-01 官方正式結算融資券 × 權證小哥避險資料庫 (第3層 保底 Fallback，已排除雙鴻等 >1200元 股票)
DEFAULT_WATCHLIST = [
    {
...
with head_col1:
    ...
    st.caption("🔥 2026-09-01 官方融資與權證小哥避險數據校準完成！嚴格過濾 1200 元以上超高價股。")
with head_col2:
    st.write("")
