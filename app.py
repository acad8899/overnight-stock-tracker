...
DEFAULT_WATCHLIST = [
    ...
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 759.00, "昨日鎖碼量": 8600, "融資增減(張)": 0, "券資比": 14.8, "權證認售(萬)": 127,
        "主力分點": [
    ...
    {
        "代號": "8039", "名稱": "台虹", "昨收": 320.50, "昨日鎖碼量": 21694, "融資增減(張)": 0, "券資比": 15.2, "權證認售(萬)": -20,
        "主力分點": [
    ...
    {
        "代號": "2313", "名稱": "華通", "昨收": 222.00, "昨日鎖碼量": 61896, "融資增減(張)": 0, "券資比": 6.5, "權證認售(萬)": 0,
        "主力分點": [
    ...
    {
        "代號": "2426", "名稱": "鼎元", "昨收": 99.80, "昨日鎖碼量": 96713, "融資增減(張)": 0, "券資比": 7.2, "權證認售(萬)": 15,
        "主力分點": [
    ...
    {
        "代號": "3260", "名稱": "威剛", "昨收": 416.00, "昨日鎖碼量": 5844, "融資增減(張)": 0, "券資比": 5.2, "權證認售(萬)": -120,
        "主力分點": [
            {"分點": "元大-總公司", "買超": 222, "均價": 417.74, "佔比": 3.80}
        ]
    },
    {
        "代號": "2615", "名稱": "萬海", "昨收": 115.00, "昨日鎖碼量": 45539, "融資增減(張)": 0, "券資比": 8.0, "權證認售(萬)": -41,
        "主力分點": [
    ...
    {
        "代號": "3189", "名稱": "景碩", "昨收": 881.00, "昨日鎖碼量": 32580, "融資增減(張)": 0, "券資比": 8.5, "權證認售(萬)": 0,
        "主力分點": [
    ...
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 181.50, "昨日鎖碼量": 139732, "融資增減(張)": 0, "券資比": 4.5, "權證認售(萬)": 0,
        "主力分點": [
    ...
    {
        "代號": "2492", "名稱": "華新科", "昨收": 269.50, "昨日鎖碼量": 32253, "融資增減(張)": 0, "券資比": 5.0, "權證認售(萬)": 0,
        "主力分點": [
...
def load_radar_market_data(pool_list):
    ...
    for item in pool_list:
        ...
        # 針對台虹的專屬連漲換手戰略指引
        if code == "8039":
            action_guide = "🔥【前日換手籌碼註記】元大/富邦仁愛/國票安和重鎖，連飆3根漲停！嚴密監控明日爆量開高走低出貨點。"
        else:
