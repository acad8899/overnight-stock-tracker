...
# ==============================================================================
st.set_page_config(
    page_title="雙 AI 量化短空雷達 (Round 11 終局結算與 R12 備戰版)", 
    layout="wide", 
    page_icon="🎯", 
...
# ==============================================================================
# 2. 官方公約常數與雙方帳戶最新狀態 (2026/09/17 R11 終局結算後正式生效)
# ==============================================================================
R11_DATE = "2026/09/17"
DATA_BASE_DATE = "2026/09/17"

# 帳戶資本與風控額度 (R11 結算更新)
CAPITAL_GEMINI = 1665595    # R10(1,620,595) + R11(+45,000)
CAPITAL_CHATGPT = 1289681   # R10(1,289,681) + R11(0)
LIMIT_GEMINI = int(CAPITAL_GEMINI * 0.20)    # NT$ 333,119
...
HISTORICAL_ROUNDS = [
    ...
    },
   {
        ...
        "gem_pnl": 77000, "gem_net": 1697595, "gem_targets": "6173 信昌電(期 T1 +9.5點), 8039 台虹(期 T1 +8點), 2327 國巨*(期 強平 +3.5點)",
        "gpt_pnl": 30000, "gpt_net": 1319681, "gpt_targets": "8039 台虹(期 T1 +7.5點)",
        "spread": 377914, "review": "大盤衝 47,038 後狂瀉！雙方共選台虹期崩跌 6.7% 同步命中 T1 保底；Gemini 多抓信昌電踩踏與國巨強平，單期大賺 7.7 萬擴大領先！"
    }
]
...
DEFAULT_WATCHLIST = [
    {
        "代號": "2455", "名稱": "全新", "昨收": 534.00, "昨日鎖碼量": 19718, "融資增減(張)": 627, "券資比": 5.8, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "6173", "名稱": "信昌電", "昨收": 303.50, "昨日鎖碼量": 28232, "融資增減(張)": 551, "券資比": 3.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "3189", "名稱": "景碩", "昨收": 815.00, "昨日鎖碼量": 10957, "融資增減(張)": 720, "券資比": 4.1, "權證認售(萬)": 0, "權證賣認購(萬)": -460,
        "最高價": 832.00, "最低價": 795.00,
        "主力分點": [
    ...
    {
        "代號": "2327", "名稱": "國巨*", "昨收": 529.00, "昨日鎖碼量": 27854, "融資增減(張)": 55, "券資比": 3.2, "權證認售(萬)": -164, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "3037", "名稱": "欣興", "昨收": 955.00, "昨日鎖碼量": 11860, "融資增減(張)": 56, "券資比": 4.8, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 971.00, "最低價": 945.00,
        "主力分點": [
    ...
    {
        "代號": "2492", "名稱": "華新科", "昨收": 297.00, "昨日鎖碼量": 15103, "融資增減(張)": -391, "券資比": 3.0, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "2313", "名稱": "華通", "昨收": 218.50, "昨日鎖碼量": 18970, "融資增減(張)": -22, "券資比": 3.9, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
    ...
    {
        "代號": "3260", "名稱": "威剛", "昨收": 395.00, "昨日鎖碼量": 3365, "融資增減(張)": -194, "券資比": 4.2, "權證認售(萬)": 0, "權證賣認購(萬)": 1580,
        "最高價": 405.50, "最低價": 395.00,
        "主力分點": [
            {"分點": "美好-富順", "買超": 294, "均價": 394.44, "佔比": 8.74},
            {"分點": "台灣摩根士丹利", "買超": -247, "均價": 393.75, "佔比": -7.34}
        ]
    },
    {
        "代號": "2344", "名稱": "華邦電", "昨收": 170.00, "昨日鎖碼量": 83218, "融資增減(張)": -2056, "券資比": 2.1, "權證認售(萬)": -207, "權證賣認購(萬)": 0,
        "最高價": 180.00, "最低價": 170.00,
        "主力分點": [
            {"分點": "美商高盛", "買超": 4925, "均價": 166.79, "佔比": 5.92},
            {"分點": "摩根大通", "買超": -2543, "均價": 167.86, "佔比": -3.06}
        ]
    },
    {
        "代號": "2408", "名稱": "南亞科", "昨收": 488.00, "昨日鎖碼量": 36437, "融資增減(張)": -741, "券資比": 2.8, "權證認售(萬)": 0, "權證賣認購(萬)": 0,
        "最高價": 504.00, "最低價": 488.00,
        "主力分點": [
            {"分點": "元大", "買超": 1924, "均價": 484.67, "佔比": 5.28},
            {"分點": "永豐金", "買超": -897, "均價": 485.66, "佔比": -2.46}
        ]
    },
    {
        "代號": "3406", "名稱": "玉晶光", "昨收": 965.00, "昨日鎖碼量": 4089, "融資增減(張)": 153, "券資比": 5.1, "權證認售(萬)": 71, "權證賣認購(萬)": 0,
...
st.sidebar.markdown(f"**決戰輪次**：`Round 11 終局` ({R11_DATE})")
...
<div class="metric-card-gemini">
    ...
    <div style="font-size: 12px; color: #81C784;">R11 信昌電+國巨 (+NT$ 45,000)</div>
</div>
<div class="metric-card-gpt">
    ...
    <div style="font-size: 12px; color: #BBB;">R11 門檻過深無觸發 (損益 $0)</div>
</div>
""", unsafe_allow_html=True)
...
# ------------------------------------------------------------------------------
with tab_orders:
    st.subheader("⚔️ Round 11 官方決戰名冊陣列 (執法存證備查)")
    col_g, col_c = st.columns(2)
    
    with col_g:
        st.markdown("#### 🟥 Gemini 戰情室封單 (R11 獲勝)")
        st.caption(f"結算淨值：NT$ {CAPITAL_GEMINI:,}｜單檔上限：NT$ {LIMIT_GEMINI:,}")
    ...
    with col_c:
        ...
        st.caption(f"結算淨值：NT$ {CAPITAL_CHATGPT:,}｜單檔上限：NT$ {LIMIT_CHATGPT:,}")
    ...
    cn1.error("🚫 **3406 玉晶光**\n\n早盤大衝 1,045 元後劇烈洗盤至 947 元，振幅逼近 100 點，官方維持絕對禁空成功避險。")
    cn2.error("🚫 **2344 華邦電**\n\n早盤衝高 180 元後維持在 170 之上，多方動能未退，嚴禁追空。")
    cn3.error("🚫 **2408 南亞科**\n\n早盤暴衝 504 元，外資低接多方強勢，禁空判定完全避開早盤強軋。")
...
# ------------------------------------------------------------------------------
# TAB 5: 🏆 R1~R11 淨值覆盤庫 (含最新 Round 11 覆盤)
# ------------------------------------------------------------------------------
with tab_history:
...
# ==============================================================================
st.markdown("---")
st.caption(f"雙 AI 量化短空雷達系統 v11.0 旗艦版｜2026/09/17 Round 11 終局結算與 R12 備戰｜執法標準：5分K實體跌破 + 不利撮合滑價 + 方案A鎖利 + 13:25強平")
